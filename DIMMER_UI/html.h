...
#define html_h
  ...
  new Supla::Html::H3Tag("Connection Method");
  auto selectConnection = new Supla::Html::SelectInputParameter(
                                          SEL_CONNECTION, "Select connection");
  selectConnection->registerValue("WLAN", 0);
  selectConnection->registerValue("LAN", 1);
  new Supla::Html::DivEnd();
  */
  new Supla::Html::DivBegin("box");
